...
def get_new_RFQ():
    indexSP500= random.randint(0, 499)
    ...
    return data[indexSP500], quantity


def random_date(start, end):
     # funciton that returns the random datetime between 2 quantities
    random_hours= randrange(27)
    dateRandom = start + timedelta( hours=random_hours)
    return dateRandom
